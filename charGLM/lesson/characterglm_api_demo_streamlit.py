...
def draw_new_image(style):
    ...
    # TODO: 加上风格选项
    image_prompt = f'{style}风格。' + image_prompt.strip()
...
with st.container():
    ...
    # 使用st.selectbox()创建下拉框  
    selected_style = st.selectbox('请选择一个风格', styles)
