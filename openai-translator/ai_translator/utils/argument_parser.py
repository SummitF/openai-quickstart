...
class ArgumentParser:
    def __init__(self):
        self.parser = argparse.ArgumentParser(description='Translate English PDF book to other languages, such as Chinese.')
        ...
        # 添加目标语言参数，使用choices来限制可选值  
        self.parser.add_argument('--target_language', type=Language, choices=list(Language), 
                                 default=Language.CHINESE,
                                 help='specify target language，choices：Chinese, German, Japanese,...')  
